...
class EventScreenPage extends StatefulWidget {
  ...
  final Map likes;
  EventScreenPage({this.contestId, this.likes});

  @override
  _EventScreenPageState createState() => _EventScreenPageState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, dataSnapshot) {
        ...
        Eventwidget contest = Eventwidget.fromDocument(dataSnapshot.data);
        ...
        // var categories = category.map((e) => CircleAvatar(
        //       radius: 18,
